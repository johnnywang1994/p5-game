<template>
  <div class="view-matter-mario">
    <h1 class="text-2xl font-bold">
      Matterjs Mario Bro 1
    </h1>
    <small>
...
.controller .btn-jump:active,
.controller .btn-shoot:active,
.controller .btn-left:active,
.controller .btn-right:active {
  transform: scale(0.9);
}
